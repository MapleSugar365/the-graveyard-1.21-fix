...
public class VisitAtNightTrigger extends SimpleCriterionTrigger<VisitAtNightTrigger.TriggerInstance> {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player) implements SimpleCriterionTrigger.SimpleInstance {
        ...
        public static Criterion<TriggerInstance> instance(ContextAwarePredicate player) {
            return TGAdvancements.VISIT_AT_NIGHT.get().createCriterion(new TriggerInstance(Optional.of(player)));
        }
    }
